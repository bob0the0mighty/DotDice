...
namespace DotDice.Tests
{
    ...
    public class AdditionalDiceNotationTests
    {
        ...
        {
            // Advantage: 2d20kh1
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 8, 15 });
            var advantage = "2d20kh1".ParseRoll(rng);
            Assert.That(advantage, Is.EqualTo(15));

            // Disadvantage: 2d20kl1  
            rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 8, 15 });
        ...
        public void ParseRoll_DnD_AbilityScoreGeneration()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 6, 5, 4, 2 });
        ...
        public void ParseRoll_Shadowrun_SuccessCounting()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 5, 3, 6, 1, 4 });
        ...
        public void ParseRoll_WhiteWolf_SuccessesAndBotches()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 8, 1, 9, 5, 10 });
        ...
        public void ParseRoll_Exalted_ExplodingSuccesses()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 7, 10, 8, 3, 5 }); // 10 explodes to 8
        ...
        public void ParseRoll_LargeDiceCount_HandlesCorrectly()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(values);
        ...
        {
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 50 });
        ...
        {
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 10 });
        ...
        public void ParseRoll_DropLowestWithReroll_ComplexInteraction()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 1, 4, 6, 3, 5 }); // First die rerolls 1 to 5
        ...
        public void ParseRoll_ExplodingWithSuccessCount_ComplexInteraction()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 6, 5, 3, 4, 1 }); // 6 explodes to 5
        ...
        public void ParseRoll_CompoundingDice_VerifyBehavior()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 6, 6, 3, 4 }); // 6+6+3=15, then 4
            var compounding = "2d6^=6".ParseRoll(rng);
            Assert.That(compounding, Is.EqualTo(19)); // 15 + 4

            rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 6, 6, 3, 4 }); // Same sequence
        ...
        public void ParseRollDetailed_AlwaysMatchesBasicEvaluation()
        {
            ...
            {
                var rng1 = new TestHelpers.MockRandomNumberGenerator(randomValues);
                var basicResult = notation.ParseRoll(rng1);

                var rng2 = new TestHelpers.MockRandomNumberGenerator(randomValues);
        ...
        public void ParseRollDetailed_EventCountReasonable()
        {
            ...
            var rng = new TestHelpers.MockRandomNumberGenerator(new List<int> { 2, 4, 5 });
        ...
        {
            var rng1 = new TestHelpers.MockRandomNumberGenerator(new List<int> { 2, 4, 5 });
            var normalResult = "3d6".ParseRollDetailed(rng1);

            var rng2 = new TestHelpers.MockRandomNumberGenerator(new List<int> { 6, 4, 5, 3 }); // First die explodes
